...
func (m *Message) ToJson(indent ...bool) string {
...
func (m *MessageInteractions) ToJson(indent ...bool) string {
    if len(indent) == 1 && indent[0] {
        data, _ := json.MarshalIndent(m, "", "  ")
        return string(data)
    } else {
...
type MessageInteractionsData struct {
    Version            string                                 `json:"version"`
    ID                 string                                 `json:"id"`
    Name               string                                 `json:"name"`
    Type               int                                    `json:"type"`
    Options            []MessageInteractionsDataOptions       `json:"options"`
    Attachments        []*MessageAttachment                   `json:"attachments"`
    ApplicationCommand *MessageInteractionsApplicationCommand `json:"application_command,omitempty"`
    // 交互
    CustomID      string        `json:"custom_id"`
    ComponentType ComponentType `json:"component_type"`
}
type MessageInteractionsApplicationCommand struct {
    ID                       string                       `json:"id"`
    ApplicationID            string                       `json:"application_id"`
    Version                  string                       `json:"version"`
    ...
    Options                  []MessageInteractionsOptions `json:"options"`
}
type MessageInteractionsDataOptions struct {
    Type  int         `json:"type"`
    Name  string      `json:"name"`
    Value interface{} `json:"value"`
}
type MessageInteractionsOptions struct {
    Type        int    `json:"type"`
    Name        string `json:"name"`
    Description string `json:"description"`
    Required    bool   `json:"required"`
}
type MessageInteractionsDataOption func(*MessageInteractionsData)

func WithMessageInteractionsData(applicationId, id, idVersion, cmdName string, cmdType int, opts ...MessageInteractionsDataOption) *MessageInteractionsData {
    result := &MessageInteractionsData{
        Version: idVersion,
        ID:      id,
        Name:    cmdName,
        Type:    cmdType,
        ...
        ApplicationCommand: &MessageInteractionsApplicationCommand{
            ...
            Description:              "",
            DmPermission:             false,
            Options:                  []MessageInteractionsOptions{},
        },
...
func WithMessageInteractionsDataOpt(cmdType int, name string, value interface{}) MessageInteractionsDataOption {
    return func(data *MessageInteractionsData) {
        data.Name = name
        data.Options = append(data.Options, MessageInteractionsDataOptions{
            Type:  cmdType,
            Name:  name,
            Value: value,
        })
...
func WithMessageInteractionsDataApplicationCommandOpt(cmdType int, name string, required bool, desc string) MessageInteractionsDataOption {
    return func(data *MessageInteractionsData) {
        data.ApplicationCommand.Name = name
        data.ApplicationCommand.Options = append(data.ApplicationCommand.Options, MessageInteractionsOptions{
            Type:        cmdType,
            Name:        name,
            Required:    required,
            Description: desc,
...
func WithMessageInteractionsDataOptMerge(cmdType int, name string, value interface{}, required bool, desc string) MessageInteractionsDataOption {
    return func(data *MessageInteractionsData) {
        data.Options = append(data.Options, MessageInteractionsDataOptions{
            Type:  cmdType,
            Name:  name,
