...
var (
    ...
    EndpointChannelInteractions = EndpointAPI + "interactions"
    ...
    EndpointApplicationCommandsSearch = func(cID string) string { return EndpointChannels + cID + "/application-commands/search" }
